...
//        layout.scrollDirection = .horizontal
    ...
    override func viewDidLoad()
    {
        ...
        self.collectionView1.register(DragDropCollectionViewCell.self, forCellWithReuseIdentifier: "cell1")
        ...
        self.collectionView2.register(DragDropCollectionViewCell.self, forCellWithReuseIdentifier: "cell2")
    ...
    func setupLayout() {
        NSLayoutConstraint.activate([
            ...
            collectionView1.widthAnchor.constraint(equalTo: view.safeAreaLayoutGuide.widthAnchor),
            collectionView1.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            collectionView1.heightAnchor.constraint(equalTo: view.safeAreaLayoutGuide.heightAnchor, multiplier: 0.5),
            collectionView2.topAnchor.constraint(equalTo: collectionView1.bottomAnchor),
            collectionView2.widthAnchor.constraint(equalTo: view.safeAreaLayoutGuide.widthAnchor),
            collectionView2.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            collectionView2.heightAnchor.constraint(equalTo: view.safeAreaLayoutGuide.heightAnchor, multiplier: 0.5),
    ...
    extension DragDropViewController : UICollectionViewDataSource
    {
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
        {
            if collectionView == self.collectionView1
            {
                ...
                cell.customImageView.image = UIImage(named: "google")
