...
open class DropDown : UITextField{
    ...
    weak var customDelegate: DropDownDelegate?
    ...
    func setupUI () {
        ...
        NSLayoutConstraint.activate([
            arrow.centerYAnchor.constraint(equalTo: arrowContainerView.centerYAnchor),
            arrow.centerXAnchor.constraint(equalTo: arrowContainerView.centerXAnchor),
            arrow.heightAnchor.constraint(equalToConstant: arrowSize),
            arrow.widthAnchor.constraint(equalToConstant: arrowSize),
            arrowContainerView.rightAnchor.constraint(equalTo: self.rightAnchor, constant: -5),
            arrowContainerView.centerYAnchor.constraint(equalTo: self.centerYAnchor),
            arrowContainerView.heightAnchor.constraint(equalTo: self.heightAnchor, multiplier: 0.8),
            arrowContainerView.widthAnchor.constraint(equalTo: self.heightAnchor, multiplier: 0.8),
        ])
...
extension DropDown : UITextFieldDelegate {
    public func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        customDelegate?.dropDownShouldReturn(self)
        return false
    }
    public func  textFieldDidBeginEditing(_ textField: UITextField) {
        textField.text = ""
        //self.selectedIndex = nil
        customDelegate?.endEditing(self)
        self.dataArray = self.optionArray
        touchAction()
    }
    ...
    public func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
        _ = customDelegate?.dropDown(self, shouldChangeCharactersIn: range, replacementString: string)
        if string != "" {
